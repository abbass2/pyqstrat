...
void test_tick_processing() {
    ...
    auto text_record_parser = TextRecordParser(quote_parser.get(), trade_parser.get(), oi_parser.get(), other_parser.get());
...
int run_python() {
     ...
     const char *argv2[] = {
     "ipython",
     "/Users/sal/Developer/coatbridge/lib/pyqstrat/notebooks",
     "processing_marketdata_files",
     "run"};
