...
class SeriesSignal:
    '''
    A signal created from the value of a pandas series that has boolean values
    col_name: Column name for the series to use.  
    '''
    col_name: str
    
    def __init__(self, ind_name) -> None:
        self.col_name = ind_name
    ...
    def __call__(self,
        ...
        sig_values: np.ndarray = getattr(indicator_values, self.col_name)
        return sig_values
